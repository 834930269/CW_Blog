  ...
  resizeMemos();
		...
		$(function(){
			$('#btn2').click(function(){
				...
				$.post('/note/create_canvas',{'data':image,'title':title,'category':category},function(result){
			...
			$('#btn4').click(function(){
				...
				$.post('/note/update_canvas',{'data':image,'title':title,'category':category,'id':id},function(result){
					window.location.href=result;
				})
			})
			$('#btn3').click(function(){
				...
				$.post('/note/update_content',{'text':text,'title':title,'category':category,'id':id},function(result){
					window.location.href=result;
				})
			})
			$('#btn1').click(function(){
				...
				$.post('/note/create_content',{'text':text,'title':title,'category':category},function(result){
				    window.location.href=result;
				})
			})
		})
